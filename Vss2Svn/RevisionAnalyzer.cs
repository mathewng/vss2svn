...
namespace Hpdi.Vss2Svn
{
    ...
    class RevisionAnalyzer : Worker
    {
        ...
        private readonly SortedDictionary<DateTime, LinkedList<Revision>> sortedRevisions =
            new SortedDictionary<DateTime, LinkedList<Revision>>();
        public SortedDictionary<DateTime, LinkedList<Revision>> SortedRevisions
        {
