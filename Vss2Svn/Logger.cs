...
namespace Hpdi.Vss2Svn
{
    ...
    class Logger : Worker, IDisposable
    {
        ...
        public Logger(string filename)
            : this(new FileStream(filename, FileMode.Create, FileAccess.Write, FileShare.Read, 128 * 1024, false))
        {
        }
        ...
        public Logger(Stream baseStream, Encoding encoding, IFormatProvider formatProvider) : this()
        {
        ...
        public Logger() : base(new WorkQueue(1), null)
        {
            workQueue.Idle += delegate (object sender, EventArgs e)
            {
